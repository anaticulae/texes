...
with open(os.path.join(ROOT, 'texas/__init__.py'), encoding='utf8') as fp:
...
if __name__ == "__main__":
    ...
    setuptools.setup(
        ...
        description='get the best out of it',
        install_requires=REQUIRES,
        long_description=README,
        name='texas',
        platforms='any',
        url='https://dev.package.checkitweg.de/texas',
        version=VERSION,
